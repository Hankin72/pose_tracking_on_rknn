...
POSE_FILE_PATH = "/home/10177178@zte.intra/10177178/work_code/所有单独py脚本/人体关键点检测模型/bbox_values.txt"
# POSE_FILE_PATH="/home/10177178@zte.intra/下载/image0.txt"     #关键点检测生成的labels
ONNX_PATH = "alg_st-attention_model_fall_down24x17x3_240426.onnx"
...
if ret != 0:
    ...
    exit(ret)
print('done')
# ret = rknn.export_rknn('fall_down.rknn')
# if ret != 0:
